...
When conducting a t-test in the difference in mean uncertainty between the BCNN's confidence in unperturbed vs. perturbed observations we generate a p-value of `r p_val`.
